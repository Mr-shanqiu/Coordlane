...
const coordinationRequirements = new Map([
  ["skills/coordlane/SKILL.md", ["assignment_id", "acknowledgement", "turn-entry", "pre-final", "cursor", "durable", "full sweep", "ownership", "final_gate_passed", "freshness=unknown", "non-blocking control plane", "Validator Crew", "Dock Crew", "PermissionRequest", "Attention", "Do not auto-approve"]],
